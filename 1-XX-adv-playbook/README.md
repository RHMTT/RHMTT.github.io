...
you previously made `install_apache.yml`.

Step 2: Create a folder called **apache_advanced** and a file called `apache_setup.yml`
-----------------------------------------------------------------------------

Hover over the *WORKSHOP_PROJECT* section and click the *New Folder* button

Type `apache_advanced` and hit enter. Now, click that folder so it is
selected.

Right-click the `apache_advanced` folder and select *New File*.

Type `apache_setup.yml` and hit enter.
...
- name: This is a play within a playbook
  ...
  vars:
    ...
    apache_test_message: "Hello World!  My test Apache Server"
```
